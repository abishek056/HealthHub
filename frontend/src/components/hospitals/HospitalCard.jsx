...
const HospitalCard = ({ hospital }) => {
  const totalBedsAvailable = (hospital.beds?.icu?.available || 0) + (hospital.beds?.emergency?.available || 0) + (hospital.beds?.general?.available || 0);
    ...
    <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden hover:shadow-lg transition-shadow duration-300">
      <div className="p-6">
        <div className="flex justify-between items-start">
          ...
          <div className="bg-green-100 text-green-800 text-xs font-bold px-2 py-1 rounded-full whitespace-nowrap">
