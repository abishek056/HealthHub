        ...
        {hospitals.map((hospital) => (
          ...
          >
            <div className="cursor-pointer group flex flex-col items-center">
              ...
              <div className="w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[8px] border-t-primary-600 group-hover:border-t-primary-500 -mt-1 transition-colors"></div>
            </div>
          </Marker>
        ))}
          ...
          >
            <div className="p-1">
              ...
              <div className="flex gap-2">
                 ...
                 <a 
                   href={`https://www.google.com/maps/dir/?api=1&destination=${popupInfo.location.lat},${popupInfo.location.lng}`}
                   target="_blank"
                   rel="noreferrer"
